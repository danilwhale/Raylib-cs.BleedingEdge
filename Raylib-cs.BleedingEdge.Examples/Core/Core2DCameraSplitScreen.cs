...
public class Core2DCameraSplitScreen
{
    ...
    public static void Main()
    {
        ...
        Rectangle player1 = new Rectangle(200, 200, PlayerSize, PlayerSize);
        Rectangle player2 = new Rectangle(250, 200, PlayerSize, PlayerSize);
        ...
        Rectangle splitScreenRect = new Rectangle(0.0f, 0.0f, screenCamera1.Texture.Width, -screenCamera1.Texture.Height);
